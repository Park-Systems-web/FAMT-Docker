...
const AdminPrograms = () => {
  ...
  const getPrograms = async () => {
    ...
    const programs = await axios.get(
      `${process.env.API_URL}/api/page/common/programs`,
      config,
    );
  ...
  const getSessions = async () => {
    ...
    const sessions = await axios.get(
      `${process.env.API_URL}/api/page/common/sessions`,
      config,
    );
  ...
  const getIsAdmin = async () => {
    ...
    axios
      .post(`${process.env.API_URL}/api/menu/admin`, {
        nation: pathname,
        path: `/program`,
      })
      .then((res) => {
  ...
  const getProgramAgenda = async () => {
    ...
    const result = await axios.get(
      `${process.env.API_URL}/api/page/common/programs/agenda`,
      config,
    );
  ...
  const hideToggleHandler = () => {
    setIsAdminLoading(true);
    axios
      .put(`${process.env.API_URL}/api/menu/admin`, {
        path: "/program",
        nation: pathname,
